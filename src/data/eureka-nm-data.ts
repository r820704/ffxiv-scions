...
export const eurekaNms: EurekaNm[] = [
  ...
  { id: 'taxim', nameTw: '塔克西姆', nameEn: 'Taxim', zone: 'Eureka Pagos', level: 21, trigger: { mob: { timeOfDay: 'night' } } },
  { id: 'ash-dragon', nameTw: '灰燼龍', nameEn: 'Ash Dragon', zone: 'Eureka Pagos', level: 22 },
  { id: 'glavoid', nameTw: 'Glavoid', nameEn: 'Glavoid', zone: 'Eureka Pagos', level: 23 },
  { id: 'anapos', nameTw: '安娜波', nameEn: 'Anapos', zone: 'Eureka Pagos', level: 24 },
  { id: 'hakutaku', nameTw: '白澤', nameEn: 'Hakutaku', zone: 'Eureka Pagos', level: 25 },
  { id: 'king-igloo', nameTw: '雪屋王', nameEn: 'King Igloo', zone: 'Eureka Pagos', level: 26 },
  { id: 'asag', nameTw: '阿薩格', nameEn: 'Asag', zone: 'Eureka Pagos', level: 27 },
  { id: 'surabhi', nameTw: '蘇羅毗', nameEn: 'Surabhi', zone: 'Eureka Pagos', level: 28 },
  { id: 'king-arthro', nameTw: '亞瑟羅王', nameEn: 'King Arthro', zone: 'Eureka Pagos', level: 29, trigger: { nm: { weather: ['Fog'] } } },
  { id: 'mindertaur-eldertaur', nameTw: '牛頭魔長老／看守', nameEn: 'Mindertaur/Eldertaur', zone: 'Eureka Pagos', level: 30 },
  { id: 'holy-cow', nameTw: '優雷卡聖牛', nameEn: 'Holy Cow', zone: 'Eureka Pagos', level: 31 },
  { id: 'hadhayosh', nameTw: '哈達約什', nameEn: 'Hadhayosh', zone: 'Eureka Pagos', level: 32, trigger: { nm: { weather: ['Thunder'] } } },
  { id: 'horus', nameTw: '荷魯斯', nameEn: 'Horus', zone: 'Eureka Pagos', level: 33, trigger: { nm: { weather: ['Heat Waves'] } } },
  { id: 'arch-angra-mainyu', nameTw: '總領安格拉·曼紐', nameEn: 'Arch Angra Mainyu', zone: 'Eureka Pagos', level: 34 },
  { id: 'copycat-cassie', nameTw: '複製魔花凱西', nameEn: 'Copycat Cassie', zone: 'Eureka Pagos', level: 35, trigger: { nm: { weather: ['Blizzards'] } } },
  { id: 'louhi', nameTw: '婁希', nameEn: 'Louhi', zone: 'Eureka Pagos', level: 35, trigger: { mob: { timeOfDay: 'night' } } },

  // ===== Pyros (Lv 35-50) =====
  { id: 'leucosia', nameTw: '琉科西亞', nameEn: 'Leucosia', zone: 'Eureka Pyros', level: 35, trigger: { mob: { timeOfDay: 'night' } } },
  { id: 'flauros', nameTw: '佛勞洛斯', nameEn: 'Flauros', zone: 'Eureka Pyros', level: 36 },
  { id: 'sophist', nameTw: '詭辯者', nameEn: 'the Sophist', zone: 'Eureka Pyros', level: 37 },
  { id: 'graffiacane', nameTw: '格拉菲亞卡內', nameEn: 'Graffiacane', zone: 'Eureka Pyros', level: 38 },
  { id: 'askalaphos', nameTw: '阿斯卡拉福斯', nameEn: 'Askalaphos', zone: 'Eureka Pyros', level: 39, trigger: { nm: { weather: ['Umbral Wind'] } } },
  { id: 'grand-duke-batym', nameTw: '巴欽大公爵', nameEn: 'Grand Duke Batym', zone: 'Eureka Pyros', level: 40, trigger: { mob: { timeOfDay: 'night' } } },
  { id: 'aetolus', nameTw: '艾托洛斯', nameEn: 'Aetolus', zone: 'Eureka Pyros', level: 41 },
  { id: 'lesath', nameTw: '來薩特', nameEn: 'Lesath', zone: 'Eureka Pyros', level: 42 },
  { id: 'eldthurs', nameTw: '火巨人艾爾德塞斯', nameEn: 'Eldthurs', zone: 'Eureka Pyros', level: 43 },
  { id: 'iris', nameTw: '伊麗絲', nameEn: 'Iris', zone: 'Eureka Pyros', level: 44 },
  { id: 'lamebrix-strikebocks', nameTw: '傭兵雷姆普里克斯', nameEn: 'Lamebrix Strikebocks', zone: 'Eureka Pyros', level: 45 },
  { id: 'dux', nameTw: '閃電督軍', nameEn: 'Dux', zone: 'Eureka Pyros', level: 46, trigger: { nm: { weather: ['Thunder'] } } },
  { id: 'lumber-jack', nameTw: '樵夫傑科', nameEn: 'Lumber Jack', zone: 'Eureka Pyros', level: 47 },
  { id: 'glaukopis', nameTw: '明眸', nameEn: 'Glaukopis', zone: 'Eureka Pyros', level: 48 },
  { id: 'ying-yang', nameTw: '陰·陽', nameEn: 'Ying-Yang', zone: 'Eureka Pyros', level: 49 },
  { id: 'skoll', nameTw: '斯庫爾', nameEn: 'Skoll', zone: 'Eureka Pyros', level: 50, trigger: { nm: { weather: ['Blizzards'] } } },
  { id: 'penthesilea', nameTw: '彭忒西勒亞', nameEn: 'Penthesilea', zone: 'Eureka Pyros', level: 50, trigger: { nm: { weather: ['Heat Waves'] } } },

  // ===== Hydatos (Lv 50-60) =====
  { id: 'khalamari', nameTw: '卡拉墨魚', nameEn: 'Khalamari', zone: 'Eureka Hydatos', level: 50 },
  { id: 'stegodon', nameTw: '劍齒象', nameEn: 'Stegodon', zone: 'Eureka Hydatos', level: 51 },
  { id: 'molech', nameTw: '摩洛', nameEn: 'Molech', zone: 'Eureka Hydatos', level: 52 },
  { id: 'piasa', nameTw: '皮艾薩邪鳥', nameEn: 'Piasa', zone: 'Eureka Hydatos', level: 53 },
  { id: 'frostmane', nameTw: '霜鬃獵魔', nameEn: 'Frostmane', zone: 'Eureka Hydatos', level: 54 },
  { id: 'daphne', nameTw: '達佛涅', nameEn: 'Daphne', zone: 'Eureka Hydatos', level: 55 },
  { id: 'king-goldemar', nameTw: '戈爾德馬爾王', nameEn: 'King Goldemar', zone: 'Eureka Hydatos', level: 56, trigger: { mob: { timeOfDay: 'night' } } },
  { id: 'leuke', nameTw: '琉刻', nameEn: 'Leuke', zone: 'Eureka Hydatos', level: 57 },
  { id: 'barong', nameTw: '巴龍', nameEn: 'Barong', zone: 'Eureka Hydatos', level: 58 },
  { id: 'ceto', nameTw: '刻托', nameEn: 'Ceto', zone: 'Eureka Hydatos', level: 59 },
  { id: 'provenance-watcher', nameTw: '起源守望者', nameEn: 'Provenance Watcher', zone: 'Eureka Hydatos', level: 60 },

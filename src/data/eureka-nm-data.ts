...
export const eurekaNms: EurekaNm[] = [
  ...
  { id: 'jahannam', nameTw: '哲罕南', nameEn: 'Jahannam', zone: 'Eureka Anemos', level: 7 },
  { id: 'amemet', nameTw: '阿米特', nameEn: 'Amemet', zone: 'Eureka Anemos', level: 8 },
  { id: 'caym', nameTw: '蓋因', nameEn: 'Caym', zone: 'Eureka Anemos', level: 9 },
  { id: 'bombadeel', nameTw: '龐巴德', nameEn: 'Bombadeel', zone: 'Eureka Anemos', level: 10, trigger: { timeOfDay: 'night' } },
  ...
  { id: 'white-rider', nameTw: '白騎士', nameEn: 'the White Rider', zone: 'Eureka Anemos', level: 13, trigger: { timeOfDay: 'night' } },
  ...
  { id: 'pazuzu', nameTw: '帕祖祖', nameEn: 'Pazuzu', zone: 'Eureka Anemos', level: 20, trigger: { weather: ['Gales'], timeOfDay: 'night' } },
  ...
  { id: 'king-arthro', nameTw: '亞瑟羅王', nameEn: 'King Arthro', zone: 'Eureka Pagos', level: 30, trigger: { weather: ['Fog'] } },
  ...
  { id: 'hadhayosh', nameTw: '哈達約什', nameEn: 'Hadhayosh', zone: 'Eureka Pagos', level: 33, trigger: { weather: ['Thunder'] } },
  ...
  { id: 'copycat-cassie', nameTw: '複製魔花凱西', nameEn: 'Copycat Cassie', zone: 'Eureka Pagos', level: 36, trigger: { weather: ['Blizzards'] } },
  ...
  { id: 'askalaphos', nameTw: '阿斯卡拉福斯', nameEn: 'Askalaphos', zone: 'Eureka Pyros', level: 42, trigger: { weather: ['Umbral Wind'] } },
  { id: 'grand-duke-batym', nameTw: '巴欽大公爵', nameEn: 'Grand Duke Batym', zone: 'Eureka Pyros', level: 43, trigger: { timeOfDay: 'night' } },
  ...
  { id: 'penthesilea', nameTw: '彭忒西勒亞', nameEn: 'Penthesilea', zone: 'Eureka Pyros', level: 54, trigger: { weather: ['Heat Waves'] } },
  ...
  { id: 'king-goldemar', nameTw: '戈爾德馬爾王', nameEn: 'King Goldemar', zone: 'Eureka Hydatos', level: 61, trigger: { timeOfDay: 'night' } },

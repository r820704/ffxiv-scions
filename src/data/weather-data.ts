...
export const zoneGroups: ZoneGroup[] = [
  ...
  { label: '庫爾札斯', zones: ['Ishgard', 'Coerthas Central Highlands', 'Coerthas Western Highlands', 'Empyreum'] },
  { label: '阿巴拉提亞', zones: ['The Sea of Clouds', 'Azys Lla', 'The Diadem'] },
  { label: '德拉瓦尼亞', zones: ['Idyllshire', 'The Dravanian Forelands', 'The Dravanian Hinterlands', 'The Churning Mists'] },
  { label: '摩杜納', zones: ['Mor Dhona'] },
  { label: '基拉巴尼亞', zones: ["Rhalgr's Reach", 'The Fringes', 'The Peaks', 'The Lochs'] },
  { label: '奧薩德', zones: ['The Ruby Sea', 'Yanxia', 'The Azim Steppe'] },
  { label: '遠東之國', zones: ['Kugane', 'Shirogane'] },
  { label: '諾弗蘭特', zones: ['The Crystarium', 'Eulmore', 'Lakeland', 'Kholusia', 'Amh Araeng', 'Il Mheg', "The Rak'tika Greatwood", 'The Tempest'] },
  { label: '北洋地域', zones: ['Old Sharlayan', 'Labyrinthos'] },
  { label: '伊爾薩巴德', zones: ['Radz-at-Han', 'Thavnair', 'Garlemald'] },
  { label: '星外天域', zones: ['Mare Lamentorum', 'Ultima Thule'] },
  { label: '古代世界', zones: ['Elpis'] },
  { label: '尤卡圖拉爾', zones: ['Tuliyollal', 'Urqopacha', "Kozama'uka", "Yak T'el"] },
  { label: '薩卡圖拉爾', zones: ['Solution Nine', 'Shaaloani', 'Heritage Found'] },
  { label: '無失世界', zones: ['Living Memory'] },

    ...
    <div className="overflow-hidden rounded border border-border">
      <table className="w-full text-sm table-fixed">
        <thead className="bg-muted/40 text-xs text-muted-foreground">
          <tr>
            <th className="pl-2 pr-0 md:px-2 py-0.5 text-left w-[28px] md:w-[60px]"><span className="hidden md:inline">等級</span></th>
            <th className="pl-1 pr-2 md:px-2 py-0.5 text-left md:w-[210px]">NM 名稱</th>
            ...
            <th className="px-1 py-0.5 text-left md:hidden whitespace-nowrap w-[88px]">
              <span className="grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-0.5">
                <span className="justify-self-center">觸發</span>
                <span className="text-muted-foreground">｜</span>
                <span className="justify-self-center">NM</span>
              </span>
            </th>
            <th className="pl-1 pr-2 md:px-2 py-0.5 text-right md:text-left w-[64px] md:w-[180px]">冷卻</th>
